...
export function Sidebar({ currentPage, onNavigate }: SidebarProps) {
  return (
    <div className="fixed left-0 top-16 bottom-0 w-64 bg-background/80 backdrop-blur-md border-r border-border z-40 animate-slide-in-left">
          ...
          {navigation.map((item, index) => {
            ...
            return (
              <button
                ...
                className={cn(
                  'w-full flex items-center space-x-3 px-3 py-2.5 rounded-lg transition-all duration-200 animate-fade-in hover:scale-105',
                  isActive
